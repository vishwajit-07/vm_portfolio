          ...
          >
            ...
            <div className="flex flex-wrap gap-4 items-center justify-center md:justify-start mt-4">
              <Button
                ...
                variant="outline"
                className="shimmer-effect bg-orange-500/10 border-orange-500/50 text-orange-400 px-8 h-11 rounded-full text-xs font-bold hover:bg-orange-500/20 hover:scale-105 hover:shadow-[0_0_25px_rgba(249,115,22,0.5)] transition-all duration-300"
              >
                Contact
              </Button>
          ...
          <div className="relative flex flex-col items-center md:items-end w-full md:w-auto">
            ...
            >
              <Image
                ...
                alt="Vishwajit Mavalankar profile"
                fill
                priority
            ...
            <div className="hidden md:block">
              {profile?.skills?.slice(0, 4).map((skill, index: number) => {
            ...
            <div className="grid grid-cols-3 gap-2 mt-4 md:hidden w-full max-w-xs">
              {profile?.skills?.slice(0, 6).map((skill, index: number) => (
                <motion.div
                  key={index}
