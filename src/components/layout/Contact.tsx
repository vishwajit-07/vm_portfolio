        ...
        <div className="max-w-xl">
          {success ? (
            <motion.div
              ...
              className="premium-glass p-8 md:p-12 rounded-3xl border-white/[0.05] text-center space-y-6 relative z-10 hover:shadow-[0_20px_40px_rgba(249,115,22,0.1)] transition-all duration-500"
            >
            ...
            <motion.div
              initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}
              variants={fadeInUp}
              className="premium-glass p-6 md:p-10 rounded-3xl relative z-10 hover:shadow-[0_20px_40px_rgba(249,115,22,0.1)] transition-all duration-500"
            >
              <form
              ...
              >
                ...
                <Button 
                  ...
                  className="bg-orange-500 text-white font-black px-8 h-12 text-[10px] uppercase tracking-[0.2em] rounded-xl shadow-premium hover:shadow-[0_0_40px_rgba(249,115,22,0.4)] transition-all w-full md:w-auto mt-4"
                >
